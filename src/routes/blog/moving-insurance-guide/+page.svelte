<script>
	...
	const currentPost = posts.find(p => p.slug === 'moving-insurance-guide');
	const relatedPosts = posts
		.filter(p => p.slug !== 'moving-insurance-guide' && 
			(p.tags.includes('التأمين والضمانات') || p.tags.includes('حماية الأثاث')))
		.slice(0, 3);
</script>

<svelte:head>
	<title>دليل التأمين على نقل العفش في جدة: حماية أثاثك من المخاطر | مدونة نقل العفش جدة</title>
	<meta name="description" content="كل ما تحتاج معرفته عن التأمين على نقل العفش. أنواع التغطيات، التكاليف، كيفية المطالبة بالتعويض، ونصائح لحماية ممتلكاتك." />
	<meta name="keywords" content="تأمين نقل العفش, تعويض أضرار النقل, حماية الأثاث, ضمانات شركات النقل" />
</svelte:head>
...
<article class="max-w-4xl mx-auto px-4 py-8 prose prose-lg">
	...
	<img src="/images/furniture_transportation_jeddah_specialists_saudi.jpg" alt="التأمين على نقل العفش" class="w-full rounded-lg shadow-lg mb-8" />
	...
	<section class="mb-8">
		<h2>نصائح لتجنب رفض المطالبة</h2>

		<h3>الأخطاء الشائعة التي تؤدي لرفض التعويض</h3>
		<div class="bg-red-50 p-6 rounded-lg mb-4">
			<h4 class="font-bold mb-3">❌ أخطاء يجب تجنبها:</h4>
			
			<div class="space-y-3">
				<div>
					<strong>1. عدم الإبلاغ السريع:</strong>
					<p class="text-sm text-gray-600">تأخير الإبلاغ أكثر من 48 ساعة قد يؤدي لرفض المطالبة</p>
				</div>
				
				<div>
					<strong>2. عدم حفظ الأدلة:</strong>
					<p class="text-sm text-gray-600">التخلص من القطع المتضررة قبل فحص الخبير</p>
				</div>
				
				<div>
					<strong>3. تقديم معلومات غير دقيقة:</strong>
					<p class="text-sm text-gray-600">المبالغة في قيمة الأضرار أو إخفاء معلومات مهمة</p>
				</div>
				
				<div>
					<strong>4. عدم قراءة الشروط:</strong>
					<p class="text-sm text-gray-600">عدم فهم الاستثناءات والقيود في البوليصة</p>
				</div>
			</div>
		</div>

		<h3>كيفية تقوية مطالبتك</h3>
		<div class="grid md:grid-cols-2 gap-4 mb-6">
			<div class="bg-green-50 p-4 rounded-lg">
				<h4 class="font-bold mb-2">💪 تقوية الموقف:</h4>
				<ul class="text-sm space-y-1">
					<li>• توثيق شامل بالصور والفيديو</li>
					<li>• حفظ جميع الإيصالات والوثائق</li>
					<li>• الحصول على تقييمات متعددة</li>
					<li>• التعاون الكامل مع المحققين</li>
					<li>• الصدق والشفافية في جميع المراحل</li>
				</ul>
			</div>
			<div class="bg-blue-50 p-4 rounded-lg">
				<h4 class="font-bold mb-2">🎯 التفاوض الذكي:</h4>
				<ul class="text-sm space-y-1">
					<li>• طلب شرح مفصل لأي رفض</li>
					<li>• الحصول على رأي ثانٍ من خبير مستقل</li>
					<li>• تقديم أدلة إضافية عند الحاجة</li>
					<li>• الاستعانة بمحامٍ عند الضرورة</li>
					<li>• معرفة حقوقك في الطعن</li>
				</ul>
			</div>
		</div>
	</section>
	...
	<section class="mb-8">
		<h2>البدائل والحلول الإضافية</h2>

		<h3>التأمين الذاتي (Self-Insurance)</h3>
		<div class="bg-yellow-50 p-6 rounded-lg mb-4">
			<h4 class="font-bold mb-3">🏦 إنشاء صندوق طوارئ شخصي:</h4>
			
			<div class="space-y-3">
				<div>
					<strong>المتطلبات:</strong>
					<ul class="list-disc pr-5 mt-2">
						<li>احتياطي نقدي يعادل 15-25% من قيمة الممتلكات</li>
						<li>حساب منفصل مخصص فقط لطوارئ النقل</li>
						<li>استثمار آمن وقابل للسحب السريع</li>
						<li>مراجعة دورية لكفاية المبلغ</li>
					</ul>
				</div>

				<div class="bg-white p-4 rounded border">
					<strong>حساب المثال:</strong>
					<p class="text-sm mt-1">أثاث بقيمة 100,000 ريال × 20% = 20,000 ريال احتياطي</p>
					<p class="text-sm">مقابل تكلفة تأمين سنوية: 3,000-5,000 ريال</p>
					<p class="text-sm text-green-600"><strong>التوفير السنوي: 3,000-5,000 ريال</strong></p>
				</div>
			</div>
		</div>

		<h3>الضمانات الإضافية من شركة النقل</h3>
		<div class="bg-blue-50 p-6 rounded-lg mb-4">
			<h4 class="font-bold mb-3">🤝 تعزيز الحماية مع مقدم الخدمة:</h4>
			
			<ul class="space-y-2">
				<li><strong>ضمان إضافي مدفوع:</strong> تكلفة 2-5% من قيمة الخدمة للحصول على تغطية أوسع</li>
				<li><strong>بوليصة مسؤولية مهنية:</strong> التأكد من أن الشركة تحمل تأميناً شاملاً</li>
				<li><strong>ضمان الاستبدال السريع:</strong> التزام بتوفير بديل خلال فترة محددة</li>
				<li><strong>صندوق تعويض داخلي:</strong> آلية سريعة للتعويض دون انتظار شركات التأمين</li>
			</ul>
		</div>

		<h3>التأمين المؤقت والموسمي</h3>
		<table class="w-full border-collapse mb-6">
			<thead>
				<tr class="bg-gray-100">
					<th class="border p-3 text-right">نوع التأمين</th>
					<th class="border p-3 text-right">مدة التغطية</th>
					<th class="border p-3 text-right">التكلفة</th>
					<th class="border p-3 text-right">المناسب لـ</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="border p-3">تأمين يوم واحد</td>
					<td class="border p-3">24 ساعة</td>
					<td class="border p-3">100-300 ريال</td>
					<td class="border p-3">النقل المحلي البسيط</td>
				</tr>
				<tr>
					<td class="border p-3">تأمين أسبوعي</td>
					<td class="border p-3">7 أيام</td>
					<td class="border p-3">200-600 ريال</td>
					<td class="border p-3">النقل مع تخزين مؤقت</td>
				</tr>
				<tr>
					<td class="border p-3">تأمين شهري</td>
					<td class="border p-3">30 يوم</td>
					<td class="border p-3">500-1500 ريال</td>
					<td class="border p-3">النقل المتدرج أو المعقد</td>
				</tr>
				<tr>
					<td class="border p-3">تأمين موسمي</td>
					<td class="border p-3">3-6 أشهر</td>
					<td class="border p-3">1000-3000 ريال</td>
					<td class="border p-3">النقل الدولي أو طويل المدى</td>
				</tr>
			</tbody>
		</table>
	</section>
